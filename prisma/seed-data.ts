// Datos originales de los 4 proyectos, usados solo para poblar la tabla
// Project la primera vez (prisma/seed.ts). Una vez en la base de datos, la
// fuente de verdad es el panel /admin — este archivo no se vuelve a leer en
// producción.
export type SeedPhoto = { src: string; w: number; h: number; caption?: string };
